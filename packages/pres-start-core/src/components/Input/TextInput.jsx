...
export default function TextInput({
  ...
  return (
    <div className={classNames("w-full", className)}>
      ...
      <label // this label wraps the entire visual input box for better clickability
        className={classNames(
          "relative flex items-center gap-2 rounded-lg border px-3 py-2 transition",
          "bg-white dark:bg-gray-800 min-h-[40px]",
      ...
      >
        {iconLeft && (
          <span className="text-gray-500 dark:text-gray-400">{iconLeft}</span>
        )}
