        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    >
                        {header && (
                            <h2 className="pres-modal-header text-xl font-semibold mb-4 text-gray-800 dark:text-white">{header}</h2>
                        )}
                        <IconButton
                            onClick={onClose}
                            variant="secondary"
                            ...
                            as="icon-button"
                            className="pres-modal-close-button absolute md:top-6 md:right-6 top-4 right-4"
                        />
                        {children}
                    </motion.div>
                </motion.div>
